...
public class KeysigDrv {
	...
	public static void main(String[] args) {
		...
		l.add(Keysig.newInstance("an", 0));
		l.add(Keysig.newInstance("eb", 0));
		l.add(Keysig.newInstance("ar", 0));
		l.add(Keysig.newInstance("pr", 0));
		l.add(Keysig.newInstance("ay", 0));
		l.add(Keysig.newInstance("un", 0));
		l.add(Keysig.newInstance("ul", 0));
		l.add(Keysig.newInstance("ug", 0));
		l.add(Keysig.newInstance("ep", 0));
		l.add(Keysig.newInstance("ct", 0));
